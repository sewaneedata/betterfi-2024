...
names(model_vars) <- c("All", "Number Of Predatory Lenders in 2.5 Mile Radius", "Average Income",
...
map_options <- c("num_lender_circles", names(tn_tract_dash %>% select(contains("_group"))))
map_options <- setdiff(map_options, "geometry")

#rename map_options so that they are readable on the UI
names(map_options) <- c("Number Of Predatory Lenders in 2.5 Mile Radius", "Average Income", "Median Gross Rent", "Percentage Noncitizen","Highschool Graduation Rate", "Percentage Divorced", "Percentage Veteran", "Percantage African American", "Percentage Hispanic/Latino", "Unemployment Rate")
...
names(graph_vars) <- c("Number Of Predatory Lenders in 2.5 Mile Radius", "Total Population", "Average Income", "Percentage Noncitizen","Highschool Graduation Rate", "Percentage Divorced", "Percentage Veteran","Median Gross Rent","Percantage African American", "Percentage Hispanic/Latino", "Unemployment Rate")
