# This file generates coordinates for predatory lending firm locations, and then saves it as total_lender_info.RData

# Generating coordinates for all of the addresses will take a while though, so it is recommended you run it once and do something else, or just use the RData file if we can get it to the end user.
